        ...
        <div>
          ...
          <Nav clicked={this.handleNavClick}/>
            ...
            <div className='card p-4'>
              <div className='row'>
                <div className='profileImage ml-5 mt-4'>
                  <img width="300px" src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png"/>
                </div>
                <div className='rightImage ml-auto mr-5'>
                  <Bio currentPos={this.state.currentPos} description={this.state.bio}/>
              ...
              <div className='row ml-4'>
                <div className='bottomImage mt-5 ml-2'>
                ...
                <div className='bottomImage mt-5' style={{marginLeft: '75px'}}>
